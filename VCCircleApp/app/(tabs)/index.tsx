...
<Text
      ...
      <ScrollView ref={scrollViewRef} style={styles.contentContainer} showsVerticalScrollIndicator={false}>
        <View style={styles.articleCard}>
          ...
          <Text style={styles.title}>Motilal Oswal Alternates manages modest returns from BFSI portfolio firm</Text>
          <Text style={styles.date}>15 July</Text>
          <Text style={styles.desc}>
            Motilal Oswal Alternates (MO Alts), which has been on the road to raise up to $750 million for what would be its fifth...
          </Text>
          <View style={styles.teamVCCRow}>
            <Ionicons name="person-circle-outline" size={16} color="gray" />
            <Text style={styles.teamVCCText}>TEAM VCC</Text>
          </View>
        </View>
        ...
        <View style={styles.articleListItem}>
          <Image source={require('../../assets/healthcare_item.jpg')} style={styles.articleListItemImage} />
          <View style={styles.articleListItemContent}>
            ...
            <View style={styles.articleListItemAuthorRow}>
              ...
              <Text style={styles.articleListItemAuthor}>Debjyoti Roy, Prithvi Durai</Text>
            </View>
          </View>
        ...
        <View style={styles.articleListItem}>
          <Image source={require('../../assets/kettleborough_item.jpg')} style={styles.articleListItemImage} />
          <View style={styles.articleListItemContent}>
            <View style={styles.articleListItemMeta}>
        ...
        <View style={styles.articleListItem}>
          <Image source={require('../../assets/consumer_item.jpg')} style={styles.articleListItemImage} />
          <View style={styles.articleListItemContent}>
            <View style={styles.articleListItemMeta}>
        ...
        <View style={styles.articleListItem}>
          <Image source={require('../../assets/sebi_item.jpg')} style={styles.articleListItemImage} />
          <View style={styles.articleListItemContent}>
            <View style={styles.articleListItemMeta}>
              <Text style={styles.articleListItemCategory}>FINANCE</Text>
              <Text style={styles.articleListItemDate}>15 July</Text>
        ...
        <View style={styles.latestStoriesContainer}>
          ...
          <View style={styles.latestStoryCard}>
            <Image source={require('../../assets/latest.jpg')} style={styles.latestStoryImage} />
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.lpScroll}>
    
          <View style={styles.lpCard}>
            <Image source={require('../../assets/hero.jpg')} style={styles.lpImage} />
          ...
          <View style={styles.lpCard}>
            <Image source={require('../../assets/latest.jpg')} style={styles.lpImage} />
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.RLscroll}>
    
          <View style={styles.RLCard}>
            <Image source={require('../../assets/hero.jpg')} style={styles.RLImage} />
            <Text style={styles.lpText}>
              A91 Partners makes first close of fourth India fund
            </Text>
          </View>
  ...
  <Image source={require('../../assets/mosaic-digital-logo.png')} style={styles.footerLogo} />
  ...
  <Text style={styles.footerProducts}>
    VCCircle   TechCircle   Events Training   VCCEdge   SalesEdge   PartnerEdge   Edge Insights
  </Text>
